...
class AddressOwnerFieldId {
  private final static var FIELDID_MAP : Map<String, AddressOwnerFieldId> = new ConcurrentHashMap<String, AddressOwnerFieldId>()
  var _name : String

  static function valueOf(name : String) : AddressOwnerFieldId {
    return FIELDID_MAP.get(name)
  }

  protected construct(aName : String) {
    _name = aName
    FIELDID_MAP.put(aName, this)
  }
