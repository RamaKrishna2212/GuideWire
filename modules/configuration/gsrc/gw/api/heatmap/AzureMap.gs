...
@Export
class AzureMap implements IHeatMapTemplate {
  ...
  override property get MapScriptHTML() : String {
    return  "     <link rel=\"stylesheet\" href=\"./resources/public/heatmap/azure-heatmap/webresources/atlas-drawing.min.css\" type=\"text/css\" />\n" +
            "      <link rel=\"stylesheet\" href=\"./resources/public/heatmap/azure-heatmap/webresources/atlas.min.css\" />\n"
  }

  override property get LoadingMessage() : String {
    return DisplayKey.get("Web.HeatMap.LoadingAzureMaps")
  }

  override public function renderJavaScriptTemplate(heatMap : HeatMapGenerator, mapOption : String) : String {
    return AzureMapJavaScript.renderToString(heatMap, this, mapOption)
  }

  override function javaScriptFileNames() : String[] {
    return {
        "./resources/public/heatmap/azure-heatmap/webresources/atlas.min.js",
        "./resources/public/heatmap/azure-heatmap/webresources/atlas-drawing.min.js",
        "./resources/public/heatmap/azure-heatmap/webresources/azure-maps-geolocation-control.min.js",
        "./resources/public/heatmap/azure-heatmap/dist/ClaimCenterHeatMapAzure.min.js" }
  }
