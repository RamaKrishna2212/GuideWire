...
//    print("bounding box is ${topLeft}, ${bottomRight}  effective date is ${effDate}")
  ...
  function updatePLSJoinEntries(catastrophe : Catastrophe) : int {
    ...
    var claimQuery = Query.make(Claim)
                        ...
                        .transformQueryRow(\row -> row.getColumn("Claim.ID") as Key)
  ...
  function copyToPLS(pli : CCPolicyLocationInfo, pls : PolicyLocationSummary) {
    ...
    pls.Country = typekey.Country.get(pliAddr.Country)
    pls.ExtraField1 = pliAddr.ExtraField1
    pls.ExtraField2 = pliAddr.ExtraField2
    pls.ExtraField3 = pliAddr.ExtraField3
    pls.ExtraField4 = pliAddr.ExtraField4
    pls.ExtraField5 = pliAddr.ExtraField5
    pls.ExtraField6 = pliAddr.ExtraField6
    pls.ExtraField7 = pliAddr.ExtraField7
    pls.ExtraField8 = pliAddr.ExtraField8
    pls.ExtraField9 = pliAddr.ExtraField9
    pls.ExtraField10 = pliAddr.ExtraField10
