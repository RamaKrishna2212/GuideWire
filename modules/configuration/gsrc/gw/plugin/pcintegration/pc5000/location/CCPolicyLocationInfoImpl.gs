package gw.plugin.pcintegration.pc5000.location

uses gw.api.upgrade.Coercions
uses gw.plugin.policy.location.CCPolicyLocationInfo
uses wsi.remote.gw.webservice.pc.pc5000.entities.anonymous.elements.PolicyLocationInfo_PNIAddressFields
uses wsi.remote.gw.webservice.pc.pc5000.entities.anonymous.elements.PolicyLocationInfo_PolicyLocationAddress
uses wsi.remote.gw.webservice.pc.pc5000.entities.anonymous.elements.PolicyLocationInfo_TotalInsuredValues
uses wsi.remote.gw.webservice.pc.pc5000.entities.types.complex.PolicyLocationInfo
...
class CCPolicyLocationInfoImpl implements CCPolicyLocationInfo {
  ...
  override property get PolicyLocationAddress(): Address {
    return new Address(_info.PolicyLocationAddress)
  }
  ...
  override property get TotalInsuredValues(): InsuredValue[] {
    return (_info.TotalInsuredValues.map(\insuredVal -> new InsuredValue(insuredVal)))?.toTypedArray()
  }
