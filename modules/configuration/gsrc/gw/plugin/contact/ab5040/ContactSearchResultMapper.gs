...
uses wsi.remote.gw.webservice.ab.ab5040.abcontactapi.anonymous.elements.ABContactAPIFindDuplicatesResultContainer_Results_Entry
uses wsi.remote.gw.webservice.ab.ab5040.abcontactapi.anonymous.elements.ABContactAPISearchResultContainer_Results_Entry
 ...
 */
  public static function populateContactFromSearchResult(contact:Contact, searchResult:ABContactAPISearchResultContainer_Results_Entry) {
    ...
    if (contact typeis Person) {
      ...
      contact.ClaimUpdatesViaEmailOptIn = PreferredEmailType.get(searchResult.ClaimUpdatesViaEmailOptIn)
      contact.ClaimUpdatesViaTextOptIn = PreferredPhoneNumberType.get(searchResult.ClaimUpdatesViaTextOptIn)
    ...
    contact.Score         = searchResult.Score as Integer
    ...
    address.ExtraField1    = searchResult.PrimaryAddress.ExtraField1
    address.ExtraField2    = searchResult.PrimaryAddress.ExtraField2
    address.ExtraField3    = searchResult.PrimaryAddress.ExtraField3
    address.ExtraField4    = searchResult.PrimaryAddress.ExtraField4
    address.ExtraField5    = searchResult.PrimaryAddress.ExtraField5
    address.ExtraField6    = searchResult.PrimaryAddress.ExtraField6
    address.ExtraField7    = searchResult.PrimaryAddress.ExtraField7
    address.ExtraField8    = searchResult.PrimaryAddress.ExtraField8
    address.ExtraField9    = searchResult.PrimaryAddress.ExtraField9
    address.ExtraField10    = searchResult.PrimaryAddress.ExtraField10
 ...
 */
  public static function populateContactFromDuplicateResult(contact:Contact, duplicateResult:ABContactAPIFindDuplicatesResultContainer_Results_Entry) {
    ...
    contact.Score         = duplicateResult.Score as Integer
    ...
    address.ExtraField1    = duplicateResult.PrimaryAddress.ExtraField1
    address.ExtraField2    = duplicateResult.PrimaryAddress.ExtraField2
    address.ExtraField3    = duplicateResult.PrimaryAddress.ExtraField3
    address.ExtraField4    = duplicateResult.PrimaryAddress.ExtraField4
    address.ExtraField5    = duplicateResult.PrimaryAddress.ExtraField5
    address.ExtraField6    = duplicateResult.PrimaryAddress.ExtraField6
    address.ExtraField7    = duplicateResult.PrimaryAddress.ExtraField7
    address.ExtraField8    = duplicateResult.PrimaryAddress.ExtraField8
    address.ExtraField9    = duplicateResult.PrimaryAddress.ExtraField9
    address.ExtraField10   = duplicateResult.PrimaryAddress.ExtraField10
