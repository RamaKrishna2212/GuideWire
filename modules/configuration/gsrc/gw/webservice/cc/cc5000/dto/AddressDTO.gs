 ...
 * A(n) {@link gw.webservice.cc.cc5000.dto.AddressDTO} is a DTO that represents an instance of {@link Address} for use by certain WS-I Web Services in the base product. This file is composed of basic getters and setters, plus members that make it easier for server-side code to work with DTOs, like virtual getters that query for entities by PublicID, and methods to copy fields to or from an instance of {@link Address}.
 ...
 * <p>The specific mappings for {@link gw.webservice.cc.cc5000.dto.AddressDTO} are as follows:
 ...
 */
@Export
@WsiExportable("http://guidewire.com/cc/ws/gw/webservice/cc/cc5000/dto/AddressDTO")
final class AddressDTO {
  ...
  var _extraField1          : String               as ExtraField1
  var _extraField2          : String               as ExtraField2
  var _extraField3          : String               as ExtraField3
  var _extraField4          : String               as ExtraField4
  var _extraField5          : String               as ExtraField5
  var _extraField6          : String               as ExtraField6
  var _extraField7          : String               as ExtraField7
  var _extraField8          : String               as ExtraField8
  var _extraField9          : String               as ExtraField9
  var _extraField10          : String              as ExtraField10
  ...
  final function readFrom(that : Address) : AddressDTO {
    ...
    // if field is on base class
      ...
      ExtraField1           = that.ExtraField1
      ExtraField2           = that.ExtraField2
      ExtraField3           = that.ExtraField3
      ExtraField4           = that.ExtraField4
      ExtraField5           = that.ExtraField5
      ExtraField6           = that.ExtraField6
      ExtraField7           = that.ExtraField7
      ExtraField8           = that.ExtraField8
      ExtraField9           = that.ExtraField9
      ExtraField10          = that.ExtraField10
  ...
  final function writeTo(that : Address, ignoreNullValues = true) : Address {
    // if field is on base class
      ...
      if (ExtraField1          != null or !ignoreNullValues) that.ExtraField1          = ExtraField1
      if (ExtraField2          != null or !ignoreNullValues) that.ExtraField2          = ExtraField2
      if (ExtraField3          != null or !ignoreNullValues) that.ExtraField3          = ExtraField3
      if (ExtraField4          != null or !ignoreNullValues) that.ExtraField4          = ExtraField4
      if (ExtraField5          != null or !ignoreNullValues) that.ExtraField5          = ExtraField5
      if (ExtraField6          != null or !ignoreNullValues) that.ExtraField6          = ExtraField6
      if (ExtraField7          != null or !ignoreNullValues) that.ExtraField7          = ExtraField7
      if (ExtraField8          != null or !ignoreNullValues) that.ExtraField8          = ExtraField8
      if (ExtraField9          != null or !ignoreNullValues) that.ExtraField9          = ExtraField9
      if (ExtraField10         != null or !ignoreNullValues) that.ExtraField10         = ExtraField10
   ...
   * @param bundleProvider The entity in whose Bundle to create the new Address.
   ...
   */
  final function writeToNewEntityIn(bundleProvider: BundleProvider, createNew: block(): Address = null, ignoreNullValues = true): Address {
