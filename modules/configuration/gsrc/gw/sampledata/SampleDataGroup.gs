...
enum SampleDataGroup {
  ...
  CatastropheSearch(
    //Fix for CLM-35713 - Hide Catastrophe Search on CC Sample Data
    false,
  ...
  property get IsVisibleInUIParam() : boolean {
    return _visibleInUI
  }
  ...
  function containsDataSetType(type : Type) : boolean {
    return _dataSetTypes.contains(type)
  }
