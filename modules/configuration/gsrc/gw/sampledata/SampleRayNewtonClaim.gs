  ...
  function create(bundle : Bundle) : ClaimInfo {
    ...
    var claim = claimBuilder()
        ...
        .withRiskUnit( new gw.api.databuilder.VehicleRUBuilder()
          ...
          .withCoverage( new gw.api.databuilder.VehicleCoverageBuilder()
            ...
            .withCovTerm(new FinancialCovTermBuilder()
                .withCovTermPattern(CovTermPattern.TC_PACOLLDEDUCTIBLE)
                .withFinancialAmount(500bd)))
          .withCoverage( new gw.api.databuilder.VehicleCoverageBuilder()
            .withIncidentLimit(10000bd.ofDefaultCurrency())
            .withType(TC_PACOMPREHENSIVECOV)
            .withCovTerm(new FinancialCovTermBuilder()
                .withCovTermPattern(CovTermPattern.TC_PACOMPDEDUCTIBLE)
                .withFinancialAmount(500bd)))
          .withCoverage(new gw.api.databuilder.VehicleCoverageBuilder()
      ...
      .withServiceRequest(new ServiceRequestBuilder()
        .withRequestedQuoteCompletionDateGw(BaseDate.addDays(1))
        .withExpectedQuoteCompletionDateGw(BaseDate.addDays(1))
        .withInstruction(new gw.api.databuilder.ServiceRequestInstructionBuilder()
          .withCustomerContactGw(contactDemoSample3022)
          .withSpecialistService(SampleSpecialistServicesBase.AutoRepairBody)
          .withInstructionTextGw("The insured prefers to be contacted by email")
          .withServiceAddressGw(contactDemoSampleAutoShop.AddressOwner.Address))
    ...
    var serviceRequest2 = new ServiceRequestBuilder()
        .onClaim(claim)
        .withRequestedQuoteCompletionDateGw(BaseDate.addDays(15))
        .withExpectedQuoteCompletionDateGw(BaseDate.addDays(15))
        .withInstruction(new gw.api.databuilder.ServiceRequestInstructionBuilder()
          .withCustomerContactGw(contactDemoSample3022)
          .withSpecialistService(SampleSpecialistServicesBase.AutoRepairBody)
          .withSpecialistService(SampleSpecialistServicesBase.AutoRepairAudio)
          .withInstructionTextGw("The insured prefers to be contacted by phone")
          .withServiceAddressGw(contactDemoSampleAutoShop.AddressOwner.Address))
        .withSpecialistCommMethodGw(SpecialistCommMethod.TC_GWPORTAL)
   ...
   var serviceRequest3QuoteOnly = new ServiceRequestBuilder()
        .withRequestedQuoteCompletionDateGw(BaseDate.addDays(30))
