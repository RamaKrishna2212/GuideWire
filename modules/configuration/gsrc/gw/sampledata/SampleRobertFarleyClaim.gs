  ...
  function create(bundle : Bundle) : ClaimInfo {
    ...
    var claim = claimBuilder()
      ...
      .withServiceRequest(new ServiceRequestBuilder()
        .withRequestedQuoteCompletionDateGw(BaseDate.addDays(14))
        .withExpectedQuoteCompletionDateGw(BaseDate.addDays(14))
        ...
        .withInstruction(new gw.api.databuilder.ServiceRequestInstructionBuilder()
          .withCustomerContactGw(contactDemoSample3024)
          ...
          .withServiceAddressGw(contactDemoSampleAutoShop1.AddressOwner.Address))
      ...
      .withServiceRequest(new ServiceRequestBuilder()
        .withRequestedServiceCompletionDateGw(BaseDate.addDays(7))
        .withExpectedServiceCompletionDateGw(BaseDate.addDays(7))
        .withProgress(ServiceRequestProgress.TC_DRAFT)
        .withQuoteStatus(ServiceRequestQuoteStatus.TC_NOQUOTE)
        .withKind(ServiceRequestKind.TC_SERVICEONLY)
        .withInstruction(new gw.api.databuilder.ServiceRequestInstructionBuilder()
          .withCustomerContactGw(contactDemoSample9)
          .withSpecialistService(SampleSpecialistServicesBase.AutoRepairGlass)
          .withInstructionTextGw("The claimant prefers to be contacted by email")
          .withServiceAddressGw(contactDemoSampleAutoShop2.AddressOwner.Address))
        .withSpecialistCommMethodGw(SpecialistCommMethod.TC_GWPORTAL)
