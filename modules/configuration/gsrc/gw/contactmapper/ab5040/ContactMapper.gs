 ...
 */
@Export
internal class ContactMapper extends ContactMapperCCBase {
   ...
   *
   */
  override property get Mappings() : Set<gw.contactmapper.ab5040.CCPropertyMapping> {
    return new HashSet<CCPropertyMapping>() {
      //All Contacts
      ...
      fieldMapping(Contact#AuthorizationID),
      ...
      fieldMapping(Person#SexAssignedAtBirth),
      fieldMapping(Person#PronounAggregate),
      fieldMapping(Person#PronounObjectiveText),
      fieldMapping(Person#PronounPossessiveText),
      fieldMapping(Person#PronounSubjectiveText),
      ...
      fieldMapping(Person#ClaimUpdatesViaEmailOptIn),
      fieldMapping(Person#ClaimUpdatesViaTextOptIn),
      ...
      fieldMapping(Address#ExtraField1),
      fieldMapping(Address#ExtraField2),
      fieldMapping(Address#ExtraField3),
      fieldMapping(Address#ExtraField4),
      fieldMapping(Address#ExtraField5),
      fieldMapping(Address#ExtraField6),
      fieldMapping(Address#ExtraField7),
      fieldMapping(Address#ExtraField8),
      fieldMapping(Address#ExtraField9),
      fieldMapping(Address#ExtraField10),
      computedFieldMapping(Address#ExtraFieldMapping),
      ...
      arrayMapping(Contact#OfficialIDs)
          .withABName("ABOfficialIDs"),
      fieldMapping(OfficialID#AddressBookUID)
          .withABName(MappingConstants.LINK_ID),
      fieldMapping(OfficialID#PublicID)
          .withMappingDirection(TO_XML)
          .withABName(MappingConstants.EXTERNAL_PUBLIC_ID),
      fieldMapping(OfficialID#ExternalLinkID)
          .withMappingDirection(TO_XML)
          .withABName(MappingConstants.EXTERNAL_UNIQUE_ID),
      fieldMapping(OfficialID#OfficialIDType),
      fieldMapping(OfficialID#OfficialIDValue),
      fieldMapping(OfficialID#State)
