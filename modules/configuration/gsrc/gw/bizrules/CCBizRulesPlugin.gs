...
class CCBizRulesPlugin implements ICCBizRulesPlugin {
  ...
  private function setWhiteListedMethodsOnClaim() {
    ...
    _whiteListedMethods.put(Claim#getLatestClaimAssessmentForTapID(String), "Method to find the latest claim level assessment for a particular tap ID")
    _whiteListedMethods.put(Claim#getLatestClaimAssessmentForTapIDIfHighRisk(String), "Method to return the latest claim level assessment for a particular tap ID if it is high risk")
    _whiteListedMethods.put(Claim#getLatestClaimAssessmentForTapSubtypeID(String), "Method to find the latest claim level assessment for a particular tap subtype ID")
    _whiteListedMethods.put(Claim#getLatestClaimAssessmentForTapSubtypeIDIfHighRisk(String), "Method to return the latest claim level assessment for a particular tap subtype ID if it is high risk")
  ...
  private function setWhiteListedMethodsOnExposure() {
    _whiteListedMethods.put(Exposure#getLatestClaimAssessmentForTapID(String), "Method to find the latest exposure level assessment for a particular tap ID")
    _whiteListedMethods.put(Exposure#getLatestClaimAssessmentForTapIDIfHighRisk(String), "Method to return the latest exposure level assessment for a particular tap ID if it is high risk")
    _whiteListedMethods.put(Exposure#getLatestClaimAssessmentForTapSubtypeID(String), "Method to find the latest exposure level assessment for a particular tap subtype ID")
    _whiteListedMethods.put(Exposure#getLatestClaimAssessmentForTapSubtypeIDIfHighRisk(String), "Method to return the latest exposure level assessment for a particular tap subtype ID if it is high risk")
